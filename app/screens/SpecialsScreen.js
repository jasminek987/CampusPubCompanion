              ...
              <View style={styles.card}>
                <View style={styles.cardInner}>
                  <View style={styles.rowTop}>
                    <Text style={styles.itemName} numberOfLines={1}>{item.day}: {item.name}</Text>
                    <View style={styles.pricePill}>
                      <Text style={styles.priceText}>${Number(item.specialPrice).toFixed(2)}</Text>
                    </View>
                  </View>
                  <Text style={styles.regularText}>Regular: ${Number(item.originalPrice).toFixed(2)}</Text>
