  ...
  return (
    <View style={styles.container}>
      ...
      <SectionList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity onPress={() => navigation.navigate('ItemDetail', { item })} activeOpacity={0.85} style={styles.card}>
...
const styles = StyleSheet.create({
  ...
  logo: { width: 90, height: 90, borderRadius: 45, borderWidth: 1, borderColor: '#ddd', backgroundColor: '#fff' },
  ...
  sectionTitle: { fontSize: 18, fontWeight: '800', color: '#111', textTransform: 'uppercase', letterSpacing: 1 },
  sectionUnderline: { height: 2, width: 60, marginTop: 6, backgroundColor: '#111', borderRadius: 2 },
  ...
  pricePill: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, backgroundColor: 'white', borderWidth: 1, borderColor: '#ddd', marginLeft: 12 },
